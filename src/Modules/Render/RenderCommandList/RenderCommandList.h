...
public:
    ...
    virtual void Attach(const BindKey& bind_key,
                        const std::shared_ptr<Resource>& resource = {},
                        const LazyViewDesc& view_desc = {}) = 0;
    ...
    virtual void BuildBottomLevelAS(const std::shared_ptr<Resource>& src,
                                    ...
                                    BuildAccelerationStructureFlags flags = BuildAccelerationStructureFlags::kNone) = 0;
    ...
    virtual void UpdateSubresource(const std::shared_ptr<Resource>& resource,
                                   uint32_t subresource,
                                   const void* data,
                                   uint32_t row_pitch = 0,
                                   uint32_t depth_pitch = 0) = 0;
